package com.haitran.filemanager.view;
...
public class WaveHelper {
    ...
    public ObjectAnimator getWaveShiftAnim() {
        return waveShiftAnim;
    }

    public ObjectAnimator getWaterLevelAnim() {
        return waterLevelAnim;
    }

    public ObjectAnimator getAmplitudeAnim() {
